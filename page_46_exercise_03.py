...
Solution:
    ...
    Python, character literals look just like string literals and are of the string type. To mark the difference in this book, we use single quotes to enclose single-character strings, and double quotes to
